...
if (isServer)then
{
	...
	_randomPosture = floor (random 10);
	if (_randomPosture==0)then{_me setUnitPos "UP";};
	if (_randomPosture>=1)then{_me setUnitPos "DOWN";};
	if (_randomPosture>=4)then{_me setUnitPos "Middle";};
};