...
_angle = _this select 2;
	...
	_ps setParticleParams [["\Ca\Data\ParticleEffects\Universal\universal.p3d" , 16, 12, 13, 0], "", "Billboard", 1, 5, [0, 0, -6], [0, 0.2, -0.03], 1, 1.275, 1, 0, [4], [[1, 1, 1, 0], [1, 1, 1, 0.08], [1, 1, 1, 0]], [1000], 1, 0, "", "", "",_angle];
	...
	while {true} do {
		...
		if (NUKE_DETONATE) exitWith {
			...
			nul1 = [360,270] execVM "fog\fog_secondary.sqf";
